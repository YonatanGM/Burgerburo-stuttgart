...
test('Bürgerbüro ZUFFENHAUSEN (Emil-Schuler-Platz 1)', async ({ page }) => {
  await page.goto('https://service.stuttgart.de/ssc-app-stuttgart/?m=32-42');
  await page.getByText('Bürgerbüro ZUFFENHAUSEN (Emil-Schuler-Platz 1) Wird am Standort nicht angeboten').click();
