...
test('Bürgerbüro OST (Schönbühlstr. 65)', async ({ page }) => {
  await page.goto('https://service.stuttgart.de/ssc-app-stuttgart/?m=32-42');
  await page.getByText('Bürgerbüro OST (Schönbühlstr. 65) Wird am Standort nicht angeboten').click();
  ...
  const office = 'Bürgerbüro OST (Schönbühlstr. 65)';
