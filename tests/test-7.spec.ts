...
test('Bürgerbüro WEST (Bebelstr. 22)', async ({ page }) => {
  await page.goto('https://service.stuttgart.de/ssc-app-stuttgart/?m=32-42');
  await page.getByText('Bürgerbüro WEST (Bebelstr. 22) Wird am Standort nicht angeboten').click();
  ...
  const office = 'Bürgerbüro WEST (Bebelstr. 22)';
