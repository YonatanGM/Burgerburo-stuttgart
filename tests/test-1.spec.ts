...
test('Bürgerbüro BAD CANNSTATT (Marktplatz 10', async ({ page }) => {
  await page.goto('https://service.stuttgart.de/ssc-app-stuttgart/?m=32-42');
  await page.getByText('Bürgerbüro BAD CANNSTATT (Marktplatz 10)').click();
  ...
  const office = 'Bürgerbüro BAD CANNSTATT (Marktplatz 10';
